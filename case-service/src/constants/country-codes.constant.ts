export type CountryCodesJSON = Record<string, string | string[]>;
export const rawCountryCode: CountryCodesJSON = {
	AF: "Afghanistan",
	AL: "Albania",
	DZ: "Algeria",
	AS: "American Samoa",
	...
	US: ["United States of America", "United States", "USA", "U.S.A.", "US", "U.S.", "U.S.A"],
