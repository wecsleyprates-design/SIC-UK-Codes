...
export const decodeInvitationToken = invitationToken => {
	const decoded = decodeURIComponent(invitationToken);
	const token = jwt.verify(decoded, envConfig.JWT_SECRET_KEY);
