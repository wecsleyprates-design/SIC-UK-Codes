...
SELECT r.business_id,
    ...
    -- ===== CREDIT SCORES =====
    (r.response->>'mkt_totalscore_avg')::numeric(10,2),
    ...
    (r.response->>'efxbma_3m_nfin_tr_count')::numeric(15,2),
    (r.response->>'efxbma_3m_nfin_tr_total_bal')::numeric(15,2),
    r.response->>'efxbma_3m_nfin_worst_payment_status',
    (r.response->>'efxbma_3m_nfin_past_due_amount')::numeric(15,2),
    (r.response->>'efxbma_3m_nfin_high_credit_lim')::numeric(15,2),
    (
